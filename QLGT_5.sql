...
--
-- Host: localhost
-- Generation Time: Nov 10, 2016 at 04:20 AM
...
CREATE TABLE `giangvien` (
  ...
  `LoaiNguoiDung` int(11) UNSIGNED DEFAULT '1',
...
INSERT INTO `giangvien` (`MaGiangVien`, `TenGiangVien`, `Email`, `MatKhau`, `DiaChi`, `SoDienThoai`, `NgaySinh`, `MaKhoa`, `MaHoiDong`, `LoaiNguoiDung`, `created_at`, `updated_at`) VALUES
(1, 'user', 'user@user', 'ee11cbb19052e40b07aac0ca060c23ee', NULL, NULL, NULL, 1, NULL, 1, NULL, NULL),
(2, 'user1', 'user1@user1', 'ee11cbb19052e40b07aac0ca060c23ee', NULL, NULL, NULL, 1, NULL, 1, NULL, NULL),
(3, 'user', 'gv@user', 'ee11cbb19052e40b07aac0ca060c23ee', NULL, NULL, NULL, 1, NULL, 1, NULL, NULL),
(4, 'user', 'tk@user', 'ee11cbb19052e40b07aac0ca060c23ee', NULL, NULL, NULL, 1, NULL, 2, NULL, NULL),
(5, 'user', 'tv1@user', 'ee11cbb19052e40b07aac0ca060c23ee', NULL, NULL, NULL, 1, NULL, 1, NULL, NULL),
(6, 'admin', 'admin@admin', '21232f297a57a5a743894a0e4a801fc3', NULL, NULL, NULL, 1, NULL, 3, NULL, NULL);
...
INSERT INTO `khoa` (`MaKhoa`, `TenKhoa`, `created_at`, `updated_at`) VALUES
(1, 'CNTT', NULL, NULL);
